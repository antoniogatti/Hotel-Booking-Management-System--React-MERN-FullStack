...
export const roomCatalog: Record<RoomSlug, RoomCatalogEntry> = {
  verdeca: {
    ...
    originalUrl: "https://palazzopintobnb.com/en/rooms/room-verdeca/",
    pricePerNight: 110,
  ...
  malvasia: {
    ...
    originalUrl: "https://palazzopintobnb.com/en/rooms/room-malvasia/",
    pricePerNight: 100,
    type: ["Boutique", "Romantic"],
    facilities: ["Free WiFi", "Non-Smoking Rooms"],
    customPage: true,
  ...
  aleatico: {
    ...
    originalUrl: "https://palazzopintobnb.com/en/rooms/aleatico-apartment/",
    pricePerNight: 130,
  ...
  fuocorosa: {
    ...
    originalUrl: "https://palazzopintobnb.com/en/",
    pricePerNight: 140,
    type: ["Boutique", "Self Catering", "Family"],
