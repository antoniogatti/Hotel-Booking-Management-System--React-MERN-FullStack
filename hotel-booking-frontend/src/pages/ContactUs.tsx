        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5 bg-white border border-[#e7e9df] rounded-[28px] p-6 sm:p-8 shadow-soft">
            ...
            <div className="space-y-4 text-[#3f4d5f] leading-7 text-[15px] sm:text-base">
              <p>
                Use this page to write to us directly about availability, your stay, special requests,
                or anything else you would like to clarify before booking.
              </p>
              <p>
                We usually reply as quickly as possible and we are happy to help with practical details,
                room questions, and personalised guidance for your visit to Brindisi.
              </p>
            </div>

            <div className="mt-8 space-y-5 text-[#2b4463]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-[#2b4463]/85 hover:text-[#ea836c] transition-colors break-all"
                  >
            ...
            <div className="mt-8 overflow-hidden rounded-[24px] border border-[#e7e9df] bg-[#f6f2ea]">
              <img
                src="/home/home-story.png"
                alt="Palazzo Pinto building in Brindisi"
                className="h-[220px] w-full object-cover"
              />
              <div className="p-5">
                <p className="text-xs uppercase tracking-[0.2em] text-[#ea836c] font-semibold mb-2">Need arrival details?</p>
                <p className="text-sm text-[#495463] leading-6 mb-4">
                  For directions, transfer notes, and map guidance, use our dedicated Reach Us page.
                </p>
                <Link
                  to="/reach-us"
                  className="inline-flex items-center justify-center rounded-lg bg-[#2b4463] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#1f334a] transition-colors"
                >
                  Go to Reach Us
                </Link>
              </div>
          ...
          <div className="lg:col-span-7 bg-white border border-[#e7e9df] rounded-[28px] p-6 sm:p-8 shadow-soft">
            ...
            <p className="text-[#3f4d5f] leading-7 mb-8">
              Write to us if you would like assistance with a reservation, room selection,
              check-in planning, or any other question related to your stay.
            </p>
